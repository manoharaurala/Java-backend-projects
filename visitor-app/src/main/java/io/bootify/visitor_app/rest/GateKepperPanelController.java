...
public class GateKepperPanelController {
    ...
    static final String basePath = "G:/JAVA Backend Course/MyCode/visitor-app/src/main/resources/static";
    ...
    @ApiResponse(responseCode = "200")
    public ResponseEntity<String> markExit(@PathVariable final Long vistId) {
        visitService.markExit(vistId);
        return new ResponseEntity<>("updated",HttpStatus.CREATED);
    }
